...
export function ChatIncomingToastHost() {
  ...
  const toast = useDriverStore((s) => s.pendingChatToast);
  const activeChatRoomId = useDriverStore((s) => s.activeChatRoomId);
  const clearChatToast = useDriverStore((s) => s.clearChatToast);
